    ...
    public partial class seed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_Role_Mapping", x => new { x.UserId, x.RoleId })
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                        name: "FK_User_Role_Mapping_Role_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_User_Role_Mapping_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockMaterial_MaterialGroup_MaterialGroupId",
                        column: x => x.MaterialGroupId,
                        principalTable: "MaterialGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockMaterial_Material_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Material",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockMaterial_Stock_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMaterial_MaterialGroupId",
                table: "StockMaterial",
                column: "MaterialGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_StockMaterial_MaterialId",
                table: "StockMaterial",
                column: "MaterialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMaterialSeries_StockMaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_Role_Mapping_RoleId",
